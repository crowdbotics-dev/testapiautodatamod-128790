...
## Project Structure
    ...
    ├── testapiautodatamod_128790  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_128790`
...
2. Clone this repo and `cd testapiautodatamod_128790`
